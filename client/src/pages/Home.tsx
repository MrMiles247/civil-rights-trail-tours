          ...
          <div className="mx-auto mb-12 grid max-w-6xl gap-8 border-b border-border pb-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-end">
            <div>
              ...
              <h2 className="text-4xl font-bold leading-tight text-foreground md:text-5xl">
                The story lives in the <span className="text-primary">experience.</span>
              </h2>
            </div>
            <p className="text-lg leading-8 text-muted-foreground md:text-xl">
              From the classroom to the kitchen, from sacred sites to living
              traditions, our travelers learn by being fully present in the
              places and communities that shape the story.
            </p>
          </div>

          <div className="mx-auto grid max-w-6xl gap-4 lg:grid-cols-12">
            <figure className="group relative min-h-[30rem] overflow-hidden border border-border lg:col-span-7">
              <img
              ...
              />
              <figcaption className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-background via-background/80 to-transparent p-6 pt-20">
            ...
            <div className="grid gap-4 lg:col-span-5">
              <figure className="group relative min-h-[14.5rem] overflow-hidden border border-border">
                <img
                  ...
                  className="h-full w-full object-cover transition duration-700 group-hover:scale-[1.03]"
                />
                <figcaption className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-background via-background/80 to-transparent p-5 pt-16">
                  <p className="text-xs font-semibold uppercase tracking-widest text-primary">
                    Jamaica
                  </p>
                  <p className="mt-1 text-xl font-bold text-foreground">
                    Food, fellowship, and place
                  </p>
                </figcaption>
              </figure>

          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-xl text-muted-foreground">
                Immersive journeys through the pivotal sites of the Civil Rights Movement, 
            ...
            {isLoading ? (
                  ...
                  return (
                    <Card key={tour.id} className="bg-background border-border hover:border-primary transition-all hover:shadow-lg flex flex-col">
                      <CardHeader>
                        ...
                        <CardTitle className="text-2xl text-foreground">{tour.name}</CardTitle>
                        <CardDescription className="text-muted-foreground">
                          {tour.description}
                        </CardDescription>
                      </CardHeader>
                      ...
                      <CardContent className="flex-1 space-y-4">
                        ...
                        {/* Highlights */}
                        <div className="space-y-2">
                          <div className="text-sm font-semibold text-foreground">Tour Highlights</div>
                          <ul className="space-y-1">
              ...
              <div className="text-center py-12">
                <p className="text-xl text-muted-foreground mb-8">
                  Tours are currently being scheduled. Please check back soon or contact us for more information.
                </p>
                <Link href="/contact">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex gap-4 p-6 bg-card rounded-lg border border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Led by knowledgeable historians with deep understanding of Civil Rights history
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-6 bg-card rounded-lg border border-border">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Authentic Sites</h3>
                    <p className="text-muted-foreground">
                      Visit actual locations where pivotal Civil Rights events took place
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-6 bg-card rounded-lg border border-border">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Curated Accommodations</h3>
                    <p className="text-muted-foreground">
                      Comfortable lodging selected for convenience and quality throughout your journey
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-6 bg-card rounded-lg border border-border">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Southern Cuisine</h3>
                    <p className="text-muted-foreground">
                      Carefully curated culinary experiences showcasing authentic Southern flavors
                    </p>
                  </div>
                </div>
              </div>

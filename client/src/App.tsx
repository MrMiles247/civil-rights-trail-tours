...
import JamaicaHeritageTrail from "./pages/Atlanta";
...
function Router() {
  return (
    <Switch>
      ...
      <Route
        path={"/jamaica-heritage-trail"}
        component={JamaicaHeritageTrail}
      />
      <Route path={"/atlanta"} component={JamaicaHeritageTrail} />
